...
## Objectives
This project has the intention to segment targeted customers based on the consumer behavior of customers. Using R language to analyze the data. Subsequence, select the most suitable segment for starting and penetrating the market for a dessert product. 
## Project Scope
